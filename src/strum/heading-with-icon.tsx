...
import Heading, { HeadingProperties as HeadingProperties } from './heading';

export interface HeadingWithIconProperties extends WithClassName {
  Icon: LucideIcon;
  level: HeadingProperties['level'];
  size?: HeadingProperties['size'];
  text?: string;
}
